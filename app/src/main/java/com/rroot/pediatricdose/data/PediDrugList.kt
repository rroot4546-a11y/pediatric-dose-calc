            ...
            mode = MultiIndicationMgPerKg(
                ...
                indications = listOf(
                    IndicationDose(
                        ...
                        route = "PO / IV / IM",
                        maxMgPerDose = 10.0,
                        note = "BNFc: 0.15 mg/kg single dose. Some centres use 0.6 mg/kg (max 16 mg).",
                    ),
                    IndicationDose(
                        ...
                        route = "PO / IV",
                        maxMgPerDose = 16.0,
                        note = "Alternative to prednisolone 1–2 mg/kg × 3 days.",
                    ),
                    IndicationDose(
                        indication = "Bacterial meningitis (≥ 3 mo)",
                        mgPerKg = 0.15,
                        frequency = "q6h × 4 days",
                        route = "IV",
                        maxMgPerDose = 10.0,
                        note = "Give with — or just before — first antibiotic dose.",
                    ),
                    IndicationDose(
                        indication = "Cerebral oedema (load)",
                        mgPerKg = 0.5,
                        frequency = "loading dose × 1",
                        route = "IV",
                        maxMgPerDose = 24.0,
                        note = "Then 0.25 mg/kg q6h for maintenance (next row).",
                    ),
                    IndicationDose(
                        indication = "Cerebral oedema (maintenance)",
                        mgPerKg = 0.25,
                        frequency = "q6h",
                        route = "IV",
                        maxMgPerDose = 4.0,
                        note = "Total daily 1 mg/kg/day. Taper over 5–7 days.",
                    ),
                    IndicationDose(
                    ...
                    IndicationDose(
                        indication = "Post-extubation laryngeal oedema",
                        mgPerKg = 0.25,
                        frequency = "q6h × 4 doses",
                        route = "IV",
                        maxMgPerDose = 10.0,
                        note = "Start 6–12 h before planned extubation.",
                    ),
                ),
            ),
            notes = "Tap the row to see every indication. Always confirm against the live BNFc / UpToDate monograph.",
            accent = Accent.Cyan,
            reference = "BNFc 2024 / UpToDate (dexamethasone)",
            injection = InjectionDetail(
                vial = "Amp 8 mg / 2 mL = 4 mg/mL",
                dose = "see indications above",
                frequency = "see indications above",
                route = "IV / IM / PO",
                infusionTime = "slow IV push over 1–4 min",
                cautions = "Meningitis: give with / just before first antibiotic. Hyperglycaemia, GI bleed, immunosuppression with prolonged courses.",
            ),
        ),
        PediDrug(
            id = "furosemide",
